...
def fitdata(datafile, vra=None, vcensor=None, nu_rest=230.538e9, chbin=3):
    ...
    # Loop through each EB and find the minimum number of channels
    ...
    for i in range(nobs):
        ...
        # accumulate the minimum number of channels
    ...
    for i in range(nobs):
        ...
        if os.path.isfile(initialised_file):
            ...
            #print("initial dterm ", np.sum(dterm))
...
#                    dterm[jj,ii] = sgn * lndet
            ...
            #print("final dterm ", np.sum(dterm))
